...
However, the first one prints to the screen a scalar variable, `len`, and the second uses the loop to fill a scalar vector, `len`, that now holds the length of each string.  
