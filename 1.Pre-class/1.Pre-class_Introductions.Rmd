...
## 2) LEVERAGING THE R PROJECT FOR REPRODUCIBLE SCIENCE
...
All assignments in this class will require that you successfully create a Markdown-generated PDF using knitr; you will then **push** this document to the course **repository** hosted on GitHub (<https://github.com/QuantitativeBiodiversity/QB-2019>) and generate a **pull request**.
