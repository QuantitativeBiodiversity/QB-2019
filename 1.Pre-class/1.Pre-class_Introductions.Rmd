...
When the storefront appears, select the **APPS** tab on the top of the page. Once in the APPS tab use the search window in the top right corner to search for **Rstudio** and click on the Rstiudio app logo to run it.

Finally, to obtain the complete layout of the Rstuidio integrated development environment (IDE) we will open the script editor from the File menu on the top left corner:
