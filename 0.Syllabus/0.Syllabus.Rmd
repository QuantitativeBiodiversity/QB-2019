---
title: "Syllabus"
author: "Z620: Quantitative Biodiversity, Indiana University, 2019"
header-includes:
   - \usepackage{array}
output: pdf_document
...
4. Evaluate biodiversity in spatial and temporal contextx  
5. Use the R programming language to analyze and visualize biodiversity  
...
### Week 2 **Diversity Within a Sample (i.e., alpha-Diversity)**
...
### Week 4 **Diversity Among Samples (i.e., beta-Diversity)**
...
### Week 5 **Diversity Among Samples (i.e., beta-Diversity)**
...
### Week 6 **Phylogenetic Diversity: Traits**
...
### Week 7 **Phylogenetic Diversity: Communities**
...
### Week 8 **Projects and Synthesis: GitOn**
