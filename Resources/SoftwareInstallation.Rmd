...
Quantitative Biodiveristy requires that you install certain software on your personal computers, including R, RStudio, Git, and LaTeX.
...
We will install the latest version of R (v 3.3.2; "Sincere Pumpkin Patch") using the following insructions:
